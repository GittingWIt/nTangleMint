    ...
    <Layout>
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <Card className="mb-8">
          ...
          <CardContent>
            <p>nTangleMint utilizes cutting-edge blockchain technology, specifically the Bitcoin Satoshi Vision (BSV) blockchain, to ensure transparency, security, and efficiency in all our loyalty programs. By leveraging NFTs, we create unique, tradeable loyalty tokens that provide real value to customers while offering businesses powerful tools for engagement and analytics.</p>
          </CardContent>
        </Card>
        ...
        <Card className="mb-8">
          ...
          <CardContent>
            <p>Whether you're a business looking to enhance your customer loyalty or a consumer eager to maximize your rewards, nTangleMint has something for you. Join us in shaping the future of loyalty programs and experience the power of blockchain-based rewards today!</p>
          </CardContent>
        </Card>
